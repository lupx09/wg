...
export function RenderMessage({
  ...
  // Remove the tool-related logic entirely.
  // We will now only render parts that are text or reasoning.
  return (
    <>
      {message.parts?.map((part, index) => {
        ...
        switch (part.type) {
          ...
          // Explicitly handle and do nothing for 'tool-invocation' and any other part types
          default:
            return null
        }
      })}
